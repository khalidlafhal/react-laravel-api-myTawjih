...
const SidebarAdmin = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  useEffect(() => {
   ...
   return (
     <aside
       ref={sidebar}
       className={`absolute left-0 top-0 z-9998 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
     ...
     >
       ...
       <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
         {/* <!-- Sidebar Menu --> */}
         <nav className="mt-3 py-3 px-4 lg:mt-9 lg:px-6">
           {/* <!-- Menu Group --> */}
           <div>
             ...
             <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Etudiant --> */}
               ...
               <SidebarLinkGroup
                 activeCondition={
                   pathname === '/admin/parametrage' || pathname.includes('parametrage')
                 }
               >
                 {(handleClick, open) => {
                   return (
